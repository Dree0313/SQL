...
-- Beginner SQL: WHERE statement
-- Purpose: Learn how to filter data based on conditions
__________________________________________________________________________

-- Scenerio:
  -- You are a junior database developer at a company. Managment needs to
  -- focus on specific records in the database. You will use WHERE 
...
__________________________________________________________________________
-- 1️ Filter by equality
-- What it does: Returns rows that match a specific value
-- Why use it: Focuses only on relevant records
